...
+ Analysis Workspace {#analysis-workspace}
   ...
   + Mallar {#templates}
      ...
      + [Skapa egna mallar](analysis-workspace/templates/create-custom-templates.md)
   + Visualiseringar {#visualizations}
      ...
      + [Lägg till visualiseringar för punktdiagram](analysis-workspace/visualizations/use-scatterplot-visualizations.md)
   ...
   + Kuratera och dela {#curate-and-share}
      + [Dataljudande: Generera bildpresentationer](analysis-workspace/curate-and-share/data-storytelling-generate-slides.md)
...
+ Content Analytics {#content-analytics}
   ...
   + [Rapportering](content-analytics/reporting.md)
