...
description: I den här videon visas hur du skapar ett mobilstyrkort med hjälp av Styrkortverktyget i Customer Journey Analytics. Ge alltid dina chefer tillgång till viktiga resultatvärden och detaljerade vyer, eller uppdelningar. Scorecard Builder är ett lättanvänt gränssnitt som hjälper dig att skapa flerkanalsdashboards med Customer Journey Analytics datavyer.
